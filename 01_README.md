...
# How to run: 
The python scripts run well in jupyter notebook, it is necessary to run the programs in the prespecified order to ensure that the stored CSV file from the previous program is available for the next.
